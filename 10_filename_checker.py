...
# Returns either "" if OK or the problem if we have an error.
def check_filename(filename):
    problem = ""

    # Regular expression to check filenmae is valid
    valid_char = "[A-Za-z0-9_]"

    # itereates throiugh filename and checks each letter
